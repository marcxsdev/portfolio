...
const Introduction = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center mx-[30px] md:mx-[75px] gap-8 lg:max-w-[1440px] lg:mx-auto lg:w-full">
      <div className="text-center lg:text-left max-w-[510px]">
        <h1 className="text-black font-raleway text-[52px] lg:text-[64px] font-bold leading-tight">
          Hi, I’m <br className="lg:hidden" />
          <span className="text-[#6A4C9C]">Marcos</span> 🌑
        </h1>

        <p className="text-black text-base lg:text-lg leading-6 py-7 lg:py-6">
